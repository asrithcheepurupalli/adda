...
const BADGES = [
  ...
  },
  {
    id: 'on-the-map',
    label: 'On the Map',
    desc: 'Check in somewhere',
    icon: 'pin',
    color: '#1F9BC4',
    earned: (s) => (s.checkinCount ?? 0) >= 1,
  },
  {
    id: 'shutterbug',
    label: 'Shutterbug',
    desc: 'Drop 3 photos on the map',
    icon: 'camera',
    color: '#8A57C0',
    earned: (s) => (s.photoCount ?? 0) >= 3,
  },
  {
    id: 'squad',
    label: 'Squad',
  ...
  },
  {
    id: 'wanderer',
    label: 'Wanderer',
    desc: 'Explore 25% of the city core',
    icon: 'footsteps',
    color: '#2E9E6B',
    earned: (s) => (s.explorePercent ?? 0) >= 25,
  },
  {
    id: 'pathfinder',
    label: 'Pathfinder',
    desc: 'Explore 60% of the city core',
    icon: 'compass',
    color: '#1F9BC4',
    earned: (s) => (s.explorePercent ?? 0) >= 60,
  },
  {
    id: 'regular',
    label: 'Regular',
